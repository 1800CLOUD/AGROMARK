...
class AccountaBalanceWizard(models.Model):
   ...
   date_to = fields.Date('Hasta',
                         default=fields.Date.today())
   group_by = fields.Boolean('Niveles?',
                             default=False,) 
   ...
   report_type = fields.Selection(selection=[('local', 'Local'),
                                  ...
                                  default='local',
                                  required="True")
   no_zero = fields.Boolean('Omitir ceros',
                             default=True)
   ...
   def action_confirm(self):
        report = self.env.ref('report_balance.report_balance_trial')
   ...
   def preview_html(self):
        ...
        action_report = self.env["ir.actions.report"].search(
            [
                ("report_name", "=",
                 'report_balance.balance_account_template'),
